...
public class patterns {
    public static void main(String[] args) {
        ...
        String email1 = "ais_hw123@northeastern.edu"; //positive case
        String email2 = "aishwargmail,in"; //negative case
        ...
        String pass1 = "aishS1$!"; //positive case
        String pass2 = "jydiwg "; //negative case
        ...
        String user1 = "Aishwa.kulkA"; //positive case
        String user2 = "aishwakulka "; //negative case
